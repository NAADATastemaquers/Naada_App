...
import com.example.naada.services.OnClearFromRecentService;

import java.io.IOException;

import static com.example.naada.R.drawable.ic_pause_circle_outline_black_24dp;
...
public class MusicPlayerActivity extends AppCompatActivity implements playable  {
    ...
    public void onTrackPlay() {
        CreateNotification.createNotification(MusicPlayerActivity.this, track, ic_pause_circle_outline_black_24dp,1);
        play.setImageResource( ic_pause_circle_outline_black_24dp);
        isPlaying=true;
        mediaPlayer.start();
    }
