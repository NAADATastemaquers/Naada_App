...
import com.tastemaquers.naada.data.models.Track;
import com.tastemaquers.naada.data.models.playable;
import com.tastemaquers.naada.util.CreateNotification;
import com.tastemaquers.naada.util.Dialog;
import com.tastemaquers.naada.view.service.BackgroundSoundService;
import com.tastemaquers.naada.view.service.OnClearFromRecentService;
                ...
                public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                    ...
                    if(documentSnapshot.exists()){
                       ...
                       fav_details = new fav_details(UserEmail,song_name,spotify_url,album_image_url);
                        ...
                        call.enqueue(new Callback<com.tastemaquers.naada.data.adapters.fav_details>() {
                            @Override
                            public void onResponse(Call<com.tastemaquers.naada.data.adapters.fav_details> call, Response<com.tastemaquers.naada.data.adapters.fav_details> response) {
                            Toast.makeText(getApplicationContext(),"Added to Favorites",Toast.LENGTH_LONG).show();
                            }

                            @Override
                            public void onFailure(Call<com.tastemaquers.naada.data.adapters.fav_details> call, Throwable t) {
